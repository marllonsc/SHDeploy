...
<body>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ml-auto">
               ...
               <!--  <li class="nav-item">
                ...
                <li class="nav-item">
                     <a class="btn btn-success ml-2" href="${pageContext.request.contextPath}/create">Create Project</a>
                </li>
            </ul>
        </div>
    </nav>
    ...
    <main class="container mt-4">
     ...
     <c:forEach var="project" items="${list}">
        ...
        <div class="card">
            <div class="card-body">
                <h2 class="card-title">Application - <b>${project.name}</b> Actions</h2>

					<!-- Buttons -->
					<div class="btn-group" role="group" aria-label="Project Actions">
						<c:if test="${project.init == 0}">
							<a class="btn btn-primary" href="${pageContext.request.contextPath}/init_project/${project.id}">Init
								Project</a>
						</c:if>
